          ...
          <div className="space-y-4 w-full md:w-1/2 text-center md:text-left ">
            ...
            <div className="space-y-2 text-lg">
              <p className="font-semibold text-green-700">
                Price: <span className="text-gray-900">${plant?.price}</span>
              </p>
              <p className="font-semibold text-green-700">
                Ratings:{" "}
                <span className="text-gray-900">{plant?.rating} ⭐</span>
              </p>
              <p className="font-semibold text-green-700">
                Available Stock:{" "}
                <span className="text-gray-900">{plant?.availableStock}</span>
              </p>
            </div>
